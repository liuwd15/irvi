...
class TestIRVAE:
    ...
    def test_generative_method(self, vae_module):
        ...
        assert outputs["tcr_logits"].shape == (batch_size, 20, 24)  # seq_len, vocab_size
    ...
    def test_loss_computation(self, vae_module):
        ...
        with torch.no_grad():
            ...
            generative_outputs = vae_module.generative(
                inference_outputs["z"][0] if inference_outputs["z"].dim() == 3 else inference_outputs["z"], 
...
class TestIRVI:
    ...
    def sample_adata(self):
        ...
        # TCR sequences
        tcr_sequences = [
            "CASSLAPGTQVQETQY", "CASSLVGQNTEAFF", "CASRPGQGATEAFF",
            "CSVGDTQYF", "CASSPGQGATEAFF"
        ]
